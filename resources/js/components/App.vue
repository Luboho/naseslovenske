        ...
        <div class="flex">
            ...
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <p class="pt-12 text-gray-500 text-xs uppercase font-bold">Posts</p>
                    ...
                    <router-link to="/" class="flex items-center py-2 hover:text-blue-600 text-sm">
                        ...
                        <div class="tracking-wide pl-3">Posts</div>
                    </router-link>

                    <p class="pt-12 text-gray-500 text-xs uppercase font-bold">Profiles</p>

                    <router-link to="/profiles" class="flex items-center py-2 hover:text-blue-600 text-sm">
                    ...
                    <div class="tracking-wide pl-3">Profiles</div>
                    </router-link>

                    <p class="pt-12 text-gray-500 text-xs uppercase font-bold">Settings</p>
                    <router-link to="/login" class="flex items-center py-2 hover:text-blue-600 text-sm">
                        <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
                    ...
                    <div class="tracking-wide pl-3">Login</div>
                    </router-link>
